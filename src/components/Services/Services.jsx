...
import Resume from "./Muhammad Irfantsani-new.pdf";
    ...
    <div className="services" id="services">
      ...
      <div className="cards">
        ...
        <motion.div initial={{ left: "25rem" }} whileInView={{ left: "14rem" }} transition={transition}>
          <Card emoji={HeartEmoji} heading={"Cloud"} detail={"Linux, Ubuntu, Network, Administrator, AWS Virtual"} />
        </motion.div>
        {/* second card */}
        <motion.div initial={{ left: "-11rem", top: "12rem" }} whileInView={{ left: "-4rem" }} transition={transition}>
          <Card emoji={Glasses} heading={"Programming"} detail={"Html, Css, JavaScript, React, Nodejs, Express"} />
        </motion.div>
        {/* 3rd */}
